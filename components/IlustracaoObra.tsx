...
// Comunidade). Usa só as cores da marca (amarelo, preto, branco e os
...
function Cone({ x, escala = 1 }: { x: number; escala?: number }) {
  return (
    <g transform={`translate(${x} 262) scale(${escala})`}>
      <rect x="-20" y="-6" width="40" height="7" rx="3" fill={AMARELO_ESCURO} />
      <path d="M-15 -6 L-5 -52 Q0 -56 5 -52 L15 -6 Z" fill={AMARELO} />
...
function Operario({
  ...
  return (
    <g transform={`translate(${x} 0)${espelhado ? " scale(-1 1)" : ""}`}>
      {/* pernas e botas */}
      <rect x="-12" y="212" width="11" height="46" rx="4" fill={CALCA} />
      <rect x="2" y="212" width="11" height="46" rx="4" fill={CALCA} />
      <rect x="-16" y="253" width="16" height="9" rx="4" fill="#3D3D3D" />
      <rect x="1" y="253" width="16" height="9" rx="4" fill="#3D3D3D" />
      {/* braço de trás */}
      <path d="M-16 170 L-26 206" stroke={ROUPA} strokeWidth="10" strokeLinecap="round" />
      <circle cx="-27" cy="209" r="5.5" fill={pele} />
      {/* tronco com colete refletivo */}
      <rect x="-20" y="158" width="40" height="60" rx="13" fill={ROUPA} />
      <rect x="-12" y="160" width="6" height="30" rx="2" fill={AMARELO} />
      <rect x="6" y="160" width="6" height="30" rx="2" fill={AMARELO} />
      <rect x="-20" y="188" width="40" height="7" fill={AMARELO} />
      ...
      <path d="M-16 137 A16 16 0 0 1 16 137 Z" fill={AMARELO} />
      <rect x="-2" y="121" width="4" height="16" rx="2" fill={AMARELO_ESCURO} />
      <rect x="-19" y="134" width="40" height="6" rx="3" fill={AMARELO_ESCURO} />
      {children}
    </g>
  );
}
    ...
    >
      <defs>
        <pattern id="listras-obra" width="16" height="16" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
          ...
          <rect x="8" width="8" height="16" fill={AMARELO} />
        </pattern>
      ...
      <rect x="272" y="160" width="9" height="102" rx="3" fill={METAL} />
      ...
      <path d="M190 84 h38 a10 10 0 0 1 10 10 v14 a10 10 0 0 1 -10 10 h-24 l-10 9 v-9 h-4 a10 10 0 0 1 -10 -10 v-14 a10 10 0 0 1 10 -10z" fill={ROUPA} />
      <circle cx="199" cy="101" r="3" fill="#fff" />
      <circle cx="209" cy="101" r="3" fill="#fff" />
      <circle cx="219" cy="101" r="3" fill="#fff" />
      <path d="M252 96 h38 a10 10 0 0 1 10 10 v14 a10 10 0 0 1 -10 10 h-4 v9 l-10 -9 h-24 a10 10 0 0 1 -10 -10 v-14 a10 10 0 0 1 10 -10z" fill={AMARELO} />
      ...
      <Operario x={118} pele={PELE}>
        <g className="balanco-ferramenta">
          <path d="M16 170 L32 148" stroke={ROUPA} strokeWidth="10" strokeLinecap="round" />
          <circle cx="34" cy="145" r="5.5" fill={PELE} />
          <path d="M34 145 L44 118" stroke={METAL} strokeWidth="5" strokeLinecap="round" />
          <path d="M39 112 a8 8 0 1 0 12 5 l-5 -1 l-1 -5 z" fill={METAL} />
        </g>
      </Operario>
      ...
      <Operario x={362} pele={PELE_2} espelhado>
        <g className="balanco-rolo">
          <path d="M16 172 L46 150" stroke={ROUPA} strokeWidth="10" strokeLinecap="round" />
          <circle cx="48" cy="148" r="5.5" fill={PELE_2} />
          <path d="M48 148 L56 124" stroke={TINTA} strokeWidth="4" strokeLinecap="round" />
          <rect x="44" y="108" width="26" height="12" rx="6" fill={AMARELO} transform="rotate(-18 57 114)" />
        </g>
      </Operario>
